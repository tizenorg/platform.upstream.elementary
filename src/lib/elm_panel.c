...
static const char SIG_TOGGLED[] = "toggled"; // TIZEN_ONLY(20160725): This will be merged into opensource 1.19 version
static const char SIG_SCROLL[] = "scroll";

static const Evas_Smart_Cb_Description _smart_callbacks[] = {
   {SIG_TOGGLED, ""}, // TIZEN_ONLY(20160725): This will be merged into opensource 1.19 version
   {SIG_SCROLL, ""},
              ...
              const char *source EINA_UNUSED)
{
   ...
   eo_do(obj, eo_event_callback_call(ELM_PANEL_EVENT_TOGGLED, NULL)); // TIZEN_ONLY(20160725): This will be merged into opensource 1.19 version
}
