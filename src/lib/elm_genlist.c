   ...
   if (it->itc->func.text_get)
     {
        ...
        int flag_contain_checkbox = 0;
        int flag_group_index = 0;
        int flag_group_title = 0;
        int flag_sub_title = 0;
                       ...
                       for ( ; child != NULL; child = child->next)
                         {
                            if (EINA_UNLIKELY(!eo_isa((child), ELM_CHECK_CLASS)))
                              {
                                 flag_contain_checkbox = 1;
                                 break;
                              }
                         }
                       if(flag_contain_checkbox == 0)
                         {
                            flag_group_index = 1;
             ...
             if (str_utf8)
               {
                  ...
                  if(flag_contain_checkbox == 0)
                    {
                       if(flag_group_title == 1 && flag_sub_title == 0)
                         {
                            eina_strbuf_append(buf,", group index");
                         }
                       else if(flag_group_title == 1)
                         {
                            eina_strbuf_append(buf,", group index title");
                            flag_group_title = 0;
                         }
                       else if(flag_sub_title == 1)
                         {
                            eina_strbuf_append(buf,", sub title");
                         }
                    }
               }
             //
