...
EOLIAN void
_elm_interface_atspi_accessible_info_cb_set(Eo *obj EINA_UNUSED, Elm_Interface_Atspi_Accessible_Data *pd EINA_UNUSED, Elm_Atspi_Info_Type type EINA_UNUSED, Elm_Atspi_Info_Cb cb EINA_UNUSED, void *data EINA_UNUSED)
{
